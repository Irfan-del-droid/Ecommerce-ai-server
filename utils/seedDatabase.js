 ...
 * Seeds products and creates a sample user for testing
 * Run with: node server/utils/seedDatabase.js
 */
...
async function seedDatabase() {
  try {
    console.log('\n╔══════════════════════════════════════════════════════════╗');
    console.log('║           LOKI STORES - DATABASE SEEDER                  ║');
    console.log('╚══════════════════════════════════════════════════════════╝\n');
    ...
    console.log('║   Email:    demo@lokistores.com                          ║');
    console.log('║   Password: Demo@1234                                    ║');
    console.log('║                                                          ║');
    console.log('║   Admin User:                                            ║');
    console.log('║   Email:    admin@lokistores.com                         ║');
